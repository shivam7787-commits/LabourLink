...
const seed = async () => {
  ...
  const users = await User.insertMany([
    // Customers
    { role: 'customer', name: 'Priya Sharma',   phone: '9876543210', email: 'priya.sharma@example.com', password: hashedPassword, city: 'Mumbai',   address: 'A-402, Sea Breeze Apts, Bandra West, Mumbai', status: 'active', totalBookings: 8,  walletBalance: 450,  tier: 'Gold',   loyaltyPoints: 120 },
    { role: 'customer', name: 'Rajesh Patel',   phone: '9820123456', email: 'rajesh.patel@example.com', password: hashedPassword, city: 'Pune',     address: 'Plot 12, Kalyani Nagar, Pune',               status: 'active', totalBookings: 4,  walletBalance: 200,  tier: 'Silver', loyaltyPoints: 60 },
    { role: 'customer', name: 'Anita Desai',    phone: '9811223344', email: 'anita.d@example.com',      password: hashedPassword, city: 'Delhi NCR', address: 'Flat 102, Green Park Extension, New Delhi',  status: 'active', totalBookings: 2,  walletBalance: 100,  tier: 'Bronze', loyaltyPoints: 30 },

    // Labour / Workers
    { role: 'labour', name: 'Ramesh Kumar', phone: '9876500001', email: 'ramesh.kumar@labourlink.in', password: hashedPassword, city: 'Mumbai', category: 'Electrician', trade: 'Electrician', experience: '6', status: 'active', rating: 4.9, totalJobs: 142, walletBalance: 3250, onboardingStage: 7, documents: { aadhar: true, pan: true, bank: true, photo: true, policeVerification: true },  badge: 'Certified Pro' },
    { role: 'labour', name: 'Suresh Yadav', phone: '9876500002', email: 'suresh.yadav@labourlink.in', password: hashedPassword, city: 'Mumbai', category: 'Plumber',     trade: 'Plumber',     experience: '8', status: 'active', rating: 4.8, totalJobs: 98,  walletBalance: 1800, onboardingStage: 7, documents: { aadhar: true, pan: true, bank: true, photo: true, policeVerification: true },  badge: 'Verified' },
    { role: 'labour', name: 'Dilip Verma',  phone: '9876500003', email: 'dilip.v@labourlink.in',     password: hashedPassword, city: 'Pune',   category: 'Painter',     trade: 'Painter',     experience: '4', status: 'active', rating: 4.7, totalJobs: 46,  walletBalance: 2400, onboardingStage: 7, documents: { aadhar: true, pan: true, bank: true, photo: true, policeVerification: false }, badge: 'Verified' },
    { role: 'labour', name: 'Mohan Lal',    phone: '9876500004', email: 'mohan.lal@labourlink.in',   password: hashedPassword, city: 'Mumbai', category: 'Carpenter',   trade: 'Carpenter',   experience: '5', status: 'pending', rating: 4.6, totalJobs: 12, walletBalance: 850,  onboardingStage: 4, documents: { aadhar: true, pan: false, bank: true, photo: true, policeVerification: false }, badge: 'Under Review' },
    { role: 'labour', name: 'Raju Shinde',  phone: '9876500005', email: 'raju.s@labourlink.in',      password: hashedPassword, city: 'Mumbai', category: 'Loader',      trade: 'Loader',      experience: '3', status: 'active', rating: 4.8, totalJobs: 64,  walletBalance: 1600, onboardingStage: 7, documents: { aadhar: true, pan: true, bank: true, photo: true, policeVerification: true },  badge: 'Verified' },

    // B2B Clients
    { role: 'b2b', name: 'Vikram Singhania', phone: '9899001122', email: 'v.singhania@apexinfra.com',   password: hashedPassword, city: 'Mumbai', companyName: 'Apex Infrastructure Ltd',   gst: '27AAACA9012A1ZG', contactPerson: 'Vikram Singhania (VP Operations)', status: 'active', totalContracts: 5, activeHeadcount: 24, creditLimit: 250000, monthlyBilling: 185000 },
    { role: 'b2b', name: 'Aditi Roy',        phone: '9877889900', email: 'procurement@buildcon.in',     password: hashedPassword, city: 'Pune',   companyName: 'BuildCon Projects Pvt Ltd', gst: '27AABCB8765B1ZH', contactPerson: 'Aditi Roy (Site Manager)',          status: 'active', totalContracts: 2, activeHeadcount: 12, creditLimit: 150000, monthlyBilling: 92000 }
  ]);
  ...
  const bookings = await Booking.insertMany([
    { bookingId: 'BK-2026-901', customerId: users[0]._id.toString(), customerName: 'Priya Sharma',  labourId: users[3]._id.toString(), labourName: 'Ramesh Kumar', serviceId: 'srv_elec',  serviceName: 'Certified Electrician', totalAmount: 1250, workerPayout: 937.5,  platformCommission: 312.5, otp: '8492', status: 'In Progress' },
    { bookingId: 'BK-2026-894', customerId: users[1]._id.toString(), customerName: 'Rajesh Patel', labourId: users[4]._id.toString(), labourName: 'Suresh Yadav', serviceId: 'srv_plumb', serviceName: 'Emergency Plumber',     totalAmount: 950,  workerPayout: 741.0,  platformCommission: 209.0, otp: '3219', status: 'Matched' },
    { bookingId: 'BK-2026-880', customerId: users[2]._id.toString(), customerName: 'Anita Desai',  labourId: users[5]._id.toString(), labourName: 'Dilip Verma',  serviceId: 'srv_paint', serviceName: 'Wall Painter',          totalAmount: 1800, workerPayout: 1404.0, platformCommission: 396.0, otp: '7105', status: 'Completed' },
    { bookingId: 'BK-2026-871', customerId: users[8]._id.toString(), customerName: 'Apex Infra Ltd', labourId: users[7]._id.toString(), labourName: 'Raju Shinde', serviceId: 'srv_load',  serviceName: 'Warehouse Loader',      totalAmount: 3500, workerPayout: 2800.0, platformCommission: 700.0, otp: '4920', status: 'Completed' }
  ]);
